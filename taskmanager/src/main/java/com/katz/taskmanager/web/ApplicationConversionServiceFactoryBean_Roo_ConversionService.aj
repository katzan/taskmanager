...
import com.katz.taskmanager.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Task, String> ApplicationConversionServiceFactoryBean.getTaskToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.katz.taskmanager.model.Task, java.lang.String>() {
    ...
    public Converter<Long, Task> ApplicationConversionServiceFactoryBean.getIdToTaskConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.katz.taskmanager.model.Task>() {
            public com.katz.taskmanager.model.Task convert(java.lang.Long id) {
    ...
    public Converter<String, Task> ApplicationConversionServiceFactoryBean.getStringToTaskConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.katz.taskmanager.model.Task>() {
            public com.katz.taskmanager.model.Task convert(String id) {
